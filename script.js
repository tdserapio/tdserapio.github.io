const chat = (hid, hih) => {
    ...
    setTimeout(() => {
        ...
        if (hid == 'tmay') {
            ...
            text_message.innerHTML = "Here is my YouTube Account: <a href='https://www.youtube.com/channel/UC6zYIB1rlM3IfZz7QhriOVQ'>Troy S</a> <br /> My Github Account: <a href='https://github.com/tdserapio'>Github</a> <br /> Here is my Gmail account: <a href='mailto:troy.serapio@gmail.com'>Gmail</a>  <br /> Here is my Fiverr account: <a href='https://www.fiverr.com/rusht_ser'>Gmail</a> <br /><br /> Thats all!"
        } else if (hid != 'emoji') {
